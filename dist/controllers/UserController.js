...
exports.register = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee(req, res) {
    var _req$body, name, lastname, email, password, priority, errors, existingUser, passwordHash, user, tokenPayload, token;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          _req$body = req.body, name = _req$body.name, lastname = _req$body.lastname, email = _req$body.email, password = _req$body.password, priority = _req$body.priority;
          errors = [];
          _context.prev = 2;
          //Validaciones
          if (name === "" || lastname === "") {
        ...
        case 14:
          passwordHash = crypto.createHmac("sha256", process.env.TOKEN_SECRET).update(password).digest("hex"); //Crear usuario
          _context.next = 17;
          return User.create({
            name: req.body.name,
...
exports.login = /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee2(req, res) {
    var _req$body2, email, password, errors, existingUser, passwordHash, tokenPayload, token;
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        ...
        case 9:
          ...
          passwordHash = crypto.createHmac("sha256", process.env.TOKEN_SECRET).update(password).digest("hex");
          tokenPayload = {
            id: existingUser.id,
...
exports.updateUser = /*#__PURE__*/function () {
  var _ref3 = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee3(req, res) {
    var _req$body$user, id, name, lastname, email, priority, user, existingUser;
    return _regeneratorRuntime().wrap(function _callee3$(_context3) {
      while (1) switch (_context3.prev = _context3.next) {
        case 0:
          _context3.prev = 0;
          console.log(req.body.user);
          _req$body$user = req.body.user, id = _req$body$user.id, name = _req$body$user.name, lastname = _req$body$user.lastname, email = _req$body$user.email, priority = _req$body$user.priority;
          _context3.next = 5;
          return User.findOne({
            where: {
              id: id
        ...
        case 0:
          ...
          return User.findAll({
            where: _defineProperty({}, Op.or, [{
              name: _defineProperty({}, Op.substring, "%".concat(searchData))
            }, {
              lastname: _defineProperty({}, Op.substring, "%".concat(searchData))
            }, {
              email: _defineProperty({}, Op.substring, "%".concat(searchData))
            }])
          });
        case 4:
          user = _context6.sent;

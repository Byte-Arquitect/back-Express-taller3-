...
var Reservation = db.parking_user;
var User = db.user;
...
var createReservation = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee(req, res) {
    var _req$body, user_id, parking_id, total_price, entry_time, exit_time, extra_fee, validation, entryTime, reservation;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          console.log(req.body);
          _context.prev = 1;
          _req$body = req.body, user_id = _req$body.user_id, parking_id = _req$body.parking_id, total_price = _req$body.total_price, entry_time = _req$body.entry_time, exit_time = _req$body.exit_time, extra_fee = _req$body.extra_fee;
          _context.next = 5;
        ...
        case 5:
          ...
          res.status(400).json({
            error: "Ya existe una reserva con ese usuario y estacionamiento"
          });
          _context.next = 16;
          break;
        case 10:
          // Crea una nueva reserva en la base de datos
          entryTime = new Date(req.body.entry_time).toLocaleString("es-CL");
          _context.next = 13;
        ...
        case 18:
          ...
          console.error("Error al crear la reserva:", _context.t0);
          res.status(500).json({
 ...
 */
var getReservationByUserId = /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee2(req, res) {
    var userId, reservation;
      ...
      while (1) switch (_context2.prev = _context2.next) {
        ...
        case 4:
          ...
          if (reservation) {
            ...
            res.status(404).json({
              message: "No se encontró ninguna reserva activa para este usuario."
            });
          }
          _context2.next = 12;
          break;
        case 8:
          ...
          console.error("Error al obtener la reserva:", _context2.t0);
          res.status(500).json({
  ...
  return function getReservationByUserId(_x3, _x4) {
...
var getHistory = /*#__PURE__*/function () {
    ...
    return _regeneratorRuntime().wrap(function _callee3$(_context3) {
      while (1) switch (_context3.prev = _context3.next) {
        ...
        case 21:
          ...
          console.error("Error getting historial:", _context3.t0);
          res.status(500).json({
  ...
  return function getHistory(_x5, _x6) {
    return _ref3.apply(this, arguments);
  };
}();
var reservationController = exports.reservationController = {
